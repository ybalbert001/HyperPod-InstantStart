...
function parseVllmCommand(vllmCommandString) {
  ...
  if (!isVllmCommand && !isSglangCommand) {
    throw new Error('Invalid command format. Must start with one of:\n• python3 -m vllm.entrypoints.openai.api_server\n• python3 -m sglang.launch_server');
  }
  
  let entrypointIndex, tensorParallelSize = 1;
  ...
  return {
    ...
    commandType: isVllmCommand ? 'vllm' : 'sglang'
  };
}
